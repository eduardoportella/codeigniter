						...
						<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
						  ...
						  <div class="carousel-inner">
						    <div class="carousel-item active">
						      <img class="d-block w-100" src="<?php echo base_url('assets/images/slider-image-1-1920x700.jpg') ?>" alt="First slide">
						    </div>
						    <div class="carousel-item">
						      <img class="d-block w-100" src="<?php echo base_url('assets/images/slider-image-2-1920x700.jpg') ?>" alt="Second slide">
						    </div>
						    <div class="carousel-item">
						      <img class="d-block w-100" src="<?php echo base_url('assets/images/slider-image-3-1920x700.jpg') ?>" alt="Third slide">
						    </div>
						  </div>
